...
public class ColorSetCommand extends CommandBase {
  /**
   * Creates a new ColorSetCommand.
   */

  private final FortuneWheelSubsystem fortuneWheelSubsystem;

  public ColorSetCommand( FortuneWheelSubsystem subsystem ) {
  ...
  public void initialize() {
    ...
    Robot.fortuneWheelSubsystem.colorSet();
